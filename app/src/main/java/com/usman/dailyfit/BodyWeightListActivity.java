...
public class BodyWeightListActivity extends ActionBarActivity
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView parent, View view, int position, long id) {
            Toast.makeText(BodyWeightListActivity.this, ((TextView) view).getText(), Toast.LENGTH_LONG).show();
        ...
        private void selectItem(int position) {
            ...
            if (wfragment != null) {
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.workout_list, wfragment).commit();
